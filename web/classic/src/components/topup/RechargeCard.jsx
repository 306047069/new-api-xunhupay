        ...
        {statusLoading ? (
          ...
          >
            <div className='space-y-6'>
                      ...
                      <Form.Slot label={t('选择支付方式')}>
                        <Space wrap>
                          {regularPayMethods.map((payMethod) => {
                            ...
                            const isXunhupay = payMethod.type === 'xunhupay';
                            const disabled =
                              (!enableOnlineTopUp &&
                                !isStripe &&
                                !isWaffo &&
                              ...
                              (!enableXunhupayTopUp && isXunhupay) ||
              ...
              {(enableOnlineTopUp || enableStripeTopUp || enableWaffoTopUp || enableXunhupayTopUp) && (
                <Form.Slot
                  label={
