...
import SettingsPaymentGatewayXunhupay from '../../pages/Setting/Payment/SettingsPaymentGatewayXunhupay';
      ...
      <Spin spinning={loading} size='large'>
        <Card style={{ marginTop: '10px' }}>
          ...
          >
            ...
            <Tabs.TabPane tab={t('虎皮椒支付设置')} itemKey='xunhupay'>
              <SettingsPaymentGatewayXunhupay
                options={inputs}
                refresh={onRefresh}
                hideSectionTitle
              />
