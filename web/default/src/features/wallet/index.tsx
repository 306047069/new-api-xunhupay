...
export function Wallet(props: WalletProps) {
  ...
  const { processing: pancakeProcessing, processWaffoPancakePayment } =
    useWaffoPancakePayment()
  const {
    processing: xunhupayProcessing,
    qrData: xunhupayQrData,
    dialogOpen: xunhupayDialogOpen,
    processXunhupayPayment,
    closeDialog: closeXunhupayDialog,
  } = useXunhupayPayment()
  ...
  const handleXunhupayPay = async () => {
    setPaymentLoading('xunhupay')
    try {
  ...
  return (
    <>
            ...
            >
              <div id='wallet-add-funds' className='scroll-mt-4'>
                <RechargeFormCard
                  ...
                  xunhupayMinTopup={topupInfo?.xunhupay_min_topup}
                  onXunhupayPay={handleXunhupayPay}
                />
              </div>
      ...
      <XunhupayQrDialog
        open={xunhupayDialogOpen}
        onOpenChange={closeXunhupayDialog}
        qrData={xunhupayQrData}
      />
    </>
  )
