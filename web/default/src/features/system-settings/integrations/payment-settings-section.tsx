...
import {
  XunhupaySettingsSection,
  type XunhupaySettingsValues,
} from './xunhupay-settings-section'
...
type PaymentSettingsSectionProps = {
  ...
  xunhupayDefaultValues: XunhupaySettingsValues
}
...
export function PaymentSettingsSection({
  ...
  return (
    ...
    >
      ...
      <XunhupaySettingsSection defaultValues={xunhupayDefaultValues} />
